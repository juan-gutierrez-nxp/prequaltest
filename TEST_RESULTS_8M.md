...
**Test PASSED** by inspecting [report_i.MX8M.txt](testresults/i.MX8M_20180608T211414Z/report_i.MX8M.txt) file
    ...
    TP0 (min)    = 11937 탎 = TP50 - 42 탎
    TP2.5        = 11958 탎 = TP50 - 21 탎
    TP50         = 11979 탎
    TP97.5       = 11981 탎 = TP50 + 2 탎
    TP100 (max)  = 12000 탎 = TP50 + 21 탎
    ...
    +-------------------------------------+
    KPI1a (TP95 spread  < 5000탎) = 23탎: PASS
    KPI1b (TP100 spread < 5000탎) = 63탎: PASS
         Samples outside V1 TP100 KPI: 0 out of 118 = ~0%
    
    +------------------------------------+
    | Level 2 KPI compliance (LR Stereo) |
    +------------------------------------+
    KPI2a (TP95 spread  < 150탎)= 23탎: PASS
    KPI2b (TP100 spread < 150탎) = 63탎: PASS
    ...
    Assume constant (correctable) lag is TP50(lag_탎): 11979 탎
    
             sn burstStartSN lag_탎ec uncorrected_lag_탎ec V1_KPI V2_KPI
